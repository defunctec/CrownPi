...
# Maintenance scripts
    ...
    sudo curl -o /usr/local/bin/crown-server-install.sh sudo curl -o /usr/local/bin/crown-server-install.sh https://gitlab.crownplatform.com/crown/crown-core/blob/master/scripts/crown-server-install.sh
